 ...
 * Locale forced to es (Spanish) for Argentina market.
 */
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "relative p-0 text-center text-sm flex-1 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
